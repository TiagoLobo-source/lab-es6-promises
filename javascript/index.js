      ...
      getInstruction("mashedPotatoes", 3, (step4) => {
        ...
        getInstruction("mashedPotatoes", 4, (step5) => {
          ...
          document.querySelector("#mashedPotatoes").innerHTML +=
            ...
            const mashedPotatoes = document.querySelector("#mashedPotatoesImg");
            mashedPotatoes.removeAttribute("hidden");
        });
      });
    });
  });
          ...
          obtainInstruction("steak", 5).then((step5) => {
            ...
            obtainInstruction("steak", 6).then((step6) => {
              ...
              obtainInstruction("steak", 7).then((step7) => {
                ...
                const steak = document.querySelector("#steakImg");
...
async function step0() {
    ...
    const step0 = await obtainInstruction("brusselsSprouts", 0);
      resolve( document.querySelector("#brusselsSprouts").innerHTML += `<li>${step0}</li>`);
